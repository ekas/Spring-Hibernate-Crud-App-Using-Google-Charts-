	...
	<div class='container'>
            <div class='custom-container'>
                <div class='custom-form'>           
                    ...
                    <div class="row">
                    	<a href="http://localhost:8082/02DataChartHibernate/add"><input class='custom-button btn btn-default' id='button' type='submit' name='btn' value='Add'></a>
                    </div>   
            </div>
        </div>
    </div>
              ...
              <form:form method="get" action="search">  
                ...
                <c:forEach var="empDeptClick" items="${empDeptClick}"> 
                  <tr>
                    ...
                    <sec:authorize access="hasRole('ROLE_ADMIN')">
                    	<td>                     	
                    		<a href="http://localhost:8082/02DataChartHibernate/delete/${empDeptClick.empid}"><input class='custom-button btn btn-default' id='button' type='submit' name='btn' value='Delete'></a>
                    		<a href="http://localhost:8082/02DataChartHibernate/update/${empDeptClick.empid}"><input class='custom-button btn btn-default' id='button' type='submit' name='btn' value='Update'></a>                   
                    	</td>
                    </sec:authorize> -->
                  </tr>
